...
<meta name="theme-color" content="#7952b3">
  ...
  <div class="container">
    ...
    <div class="universitas-bangka-belitung-container">
    		...
    		<p class="universitas">Universitas <br>
      Bangka Belitung
        </p>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
            ...
            <li><a class="dropdown-item" href="#">Struktur Organanisasi</a></li>
          </ul>
        </li>
        <li class="nav-item">
        ...
        <li>
        <a class="nav-link" href="/Galeri">Layanan Kemahasiswaan</a><!-- buat routes fst -->
        </li>
      </ul>
    </div>
